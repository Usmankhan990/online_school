  ...
  return (
    <div style={{ background: '#1C1917', minHeight: '100vh', display: 'flex', flexDirection: 'column', overflowX: 'hidden' }}>
      ...
      >
        ...
        {/* Main Center Content */}
        <div style={{ maxWidth: 1320, width: '100%', margin: 'auto auto', padding: '0 clamp(16px, 3vw, 32px)', position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', flex: 1 }}>
