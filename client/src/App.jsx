...
import SchoolTimeTable from './pages/shared/SchoolTimeTable';
      ...
      <AuthProvider>
        <SearchProvider>
          <Routes>
            ...
            <Route path="/admin/timetable" element={<D roles={['super_admin']}><SchoolTimeTable /></D>} />
            ...
            <Route path="/teacher/timetable" element={<D roles={['teacher']}><SchoolTimeTable /></D>} />
            ...
            <Route path="/student/timetable" element={<D roles={['student']}><SchoolTimeTable /></D>} />
            ...
            <Route path="/homework" element={<D roles={['student']}><StudentHomework /></D>} />
            ...
            <Route path="/results" element={<D roles={['student']}><StudentResults /></D>} />
            ...
            <Route path="/fees" element={<D roles={['student']}><StudentFees /></D>} />
            ...
            <Route path="/parent/child-overview" element={<D roles={['parent']}><ChildOverview /></D>} />
            <Route path="/parent/child" element={<D roles={['parent']}><ChildOverview /></D>} />
            <Route path="/parent/timetable" element={<D roles={['parent']}><SchoolTimeTable /></D>} />
